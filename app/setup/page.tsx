...
export default function Setup() {
  ...
  const interests = [
    ...
    "Copywriting", "Email Marketing", "Video Content",
    "Blogging", "Graphic Design", "Analytics"
  ];
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-[var(--background)]/20 rounded-xl">
                    <div>
                      ...
                      <p className="text-sm text-[var(--text-light)]">Receive updates and important alerts</p>
                    </div>
                    <Checkbox
                  ...
                  <div className="flex items-center justify-between p-4 bg-[var(--background)]/20 rounded-xl">
                    <div>
                      ...
                      <p className="text-sm text-[var(--text-light)]">Get reminded to create new content</p>
                    </div>
                    <Checkbox
                      isSelected={formData.preferences.contentReminders}
                      onValueChange={(checked) => handlePreferenceChange("contentReminders", checked)}
                    />
                  </div>
                  <div className="flex items-center justify-between p-4 bg-[var(--background)]/20 rounded-xl">
                    <div>
                      <h3 className="font-medium">Analytics Reports</h3>
                      <p className="text-sm text-[var(--text-light)]">Receive periodic performance reports</p>
                    </div>
                    <Checkbox
                      isSelected={formData.preferences.analyticsReports}
                      onValueChange={(checked) => handlePreferenceChange("analyticsReports", checked)}
                    />
                  </div>
                </div>
              </div>
